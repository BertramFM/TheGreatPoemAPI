...
public final class HibernateConfig {
    ...
    private static Properties buildProps() {
        ...
        /*
        create-drop	|   Sletter skema ved lukning, opretter nyt ved opstart — al data væk hver gang
        create      |	Sletter og genopretter skema ved hver opstart — al data væk hver gang
        update      |	Bevarer eksisterende data, opdaterer kun skemaet hvis entities er ændret
        validate    |	Rører intet, fejler bare hvis skema ikke matcher entities
        none        |  	Gør ingenting — I styrer skemaet 100% selv
         */
